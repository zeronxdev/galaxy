...
<html lang="vi">
	...
	<body id="kt_body" class="app-blank app-blank">
										...
										<td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
											...
											<div style="text-align:center; margin:0 15px 34px 15px">
												...
												<div style="margin-bottom: 15px">
													<img src="{$config['website_name']}/theme/galaxy/media/email/icon-positive-vote-1.svg" />
												</div>
												<!--end:Media-->
												<!--begin:Text-->
											...
											<div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
												...
												<div style="display:flex">
													...
													<div style="display: flex; justify-content: center; align-items: center; width:40px; height:40px; margin-right:13px">
														<img  src="{$config['website_name']}/theme/galaxy/media/email/icon-polygon.svg" />
									...
									<tr>
										<td align="center" valign="center" style="text-align:center; padding-bottom: 20px;">
											<a href="#" style="margin-right:10px">
												<img  src="{$config['website_name']}/theme/galaxy/media/email/icon-linkedin.svg" />
											</a>
											<a href="#" style="margin-right:10px">
												<img  src="{$config['website_name']}/theme/galaxy/media/email/icon-dribbble.svg" />
											</a>
											<a href="#" style="margin-right:10px">
												<img  src="{$config['website_name']}/theme/galaxy/media/email/icon-facebook.svg" />
											</a>
											<a href="#">
												<img  src="{$config['website_name']}/theme/galaxy/media/email/icon-twitter.svg" />
											</a>
										</td>
									</tr>
									<tr>
        ...
        <script src="{$config['website_name']}/theme/galaxy/plugins/global/plugins.bundle.js"></script>
		<script src="{$config['website_name']}/theme/galaxy/js/scripts.bundle.js"></script>
	</body>
	<!--end::Body-->
</html>