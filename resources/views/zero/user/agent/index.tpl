									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-offset="-15px, 0">
											<a href="#" class="menu-link px-5">
												...
												<img class="w-15px h-15px rounded-1 ms-2" src="/theme/galaxy/media/flags/united-states.svg" alt="" /></span></span>
											</a>
											<!--begin::Menu sub-->
											<div class="menu-sub menu-sub-dropdown w-175px py-4">
												...
												<div class="menu-item px-3">
													...
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="/theme/galaxy/media/flags/spain.svg" alt="" />
													</span>Spanish</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="#" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="/theme/galaxy/media/flags/germany.svg" alt="" />
													</span>German</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="#" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="/theme/galaxy/media/flags/japan.svg" alt="" />
													</span>Japanese</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
													<a href="#" class="menu-link d-flex px-5">
													<span class="symbol symbol-20px me-4">
														<img class="rounded-1" src="/theme/galaxy/media/flags/france.svg" alt="" />
													</span>French</a>
												</div>
												<!--end::Menu item-->
											</div>
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
												...
												<div class="card-body d-flex flex-column flex-center">
													...
													<div class="mb-2">
														...
														<div class="py-10 text-center">
															<img src="/theme/galaxy/media/svg/illustrations/easy/4.svg" class="w-200px" alt="" />
														</div>
														<!--end::Illustration-->
													</div>
													<!--end::Heading-->
								...
								{else}
									<div class="card flush">
										<div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0" style="background-position: 100% 50%;background-image:url('/theme/galaxy/media/stock/900x600/42.png');">
											<div class="mb-10">
											...
											<img class="mx-auto h-250px h-lg-400px theme-light-show" src="/theme/galaxy/media/illustrations/misc/upgrade.svg" alt>
											<img class="mx-auto h-250px h-lg-400px theme-dark-show" src="/theme/galaxy/media/illustrations/misc/upgrade-dark.svg" alt>
										</div>
									</div>
								{/if}	
                                </div>
